...
#End Region
    ...
    Private Sub Loaddata(ByVal aform As SAPbouiCOM.Form)
        aform.Freeze(True)
        oGrid = aform.Items.Item("15").Specific
        oGrid.DataTable.ExecuteQuery("Select * from [@Z_OALJDT] where isnull(U_Z_Imported,'N')='N' ")
        oGrid.Columns.Item(0).Visible = False
        oGrid.Columns.Item(1).Visible = False
        oGrid.Columns.Item(2).TitleObject.Caption = "JDT Number"
        oGrid.Columns.Item(3).TitleObject.Caption = "JDT Line"
        oGrid.Columns.Item(4).TitleObject.Caption = "GL Type"
        oGrid.Columns.Item(5).TitleObject.Caption = "Account"
        oGrid.Columns.Item(6).TitleObject.Caption = "Currency"
        oGrid.Columns.Item(7).TitleObject.Caption = "Debit"
        oGrid.Columns.Item(8).TitleObject.Caption = "Credit"
        oGrid.Columns.Item(9).TitleObject.Caption = "Due Date"
        oGrid.Columns.Item(10).TitleObject.Caption = "Line Memo"
        oGrid.Columns.Item(12).TitleObject.Caption = "Ref1"
        oGrid.Columns.Item(13).TitleObject.Caption = "Imported"
        oGrid.Columns.Item(11).TitleObject.Caption = "Profit Code"
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "13" Then
                                    If oApplication.SBO_Application.MessageBox("Do you want to continue ?.", , "Yes", "No") = 2 Then
                                        BubbleEvent = False
                                        Exit Sub
                                    Else
                                        If oApplication.Company.InTransaction() Then
                                        ...
                                        End If
                                        oApplication.Company.StartTransaction()
                                        If oApplication.Utilities.createJournalEntry() = True Then
                                            oForm.Close()
                                            If oApplication.Company.InTransaction() Then
                                                oApplication.Company.EndTransaction(SAPbobsCOM.BoWfTransOpt.wf_Commit)
                                            End If
                                ...
                                ElseIf pVal.ItemUID = "3" Then
                                    If oApplication.SBO_Application.MessageBox("Do you want to Import?", , "Yes", "No") = 2 Then
                                        Exit Sub
                                    End If
                                    If oApplication.Utilities.getEdittextvalue(oForm, "6") = "" Then
                                        ...
                                        Exit Sub
                                    End If
                                    If oApplication.Utilities.ReadALSane(oApplication.Utilities.getEdittextvalue(oForm, "6")) = False Then
                                        Dim x As System.Diagnostics.ProcessStartInfo
                                        x = New System.Diagnostics.ProcessStartInfo
                                        x.UseShellExecute = True
                                        sPath = strImportErrorLog 'System.Windows.Forms.Application.StartupPath & "\FImportLog_Invoice.txt"
                                        ...
                                        x = Nothing
                                    Else
                                        If oApplication.SBO_Application.MessageBox("Do you want view the log file ?", , "Yes", "No") = 2 Then
                                            Exit Sub
                                        End If
                                        Dim x As System.Diagnostics.ProcessStartInfo
                                        x = New System.Diagnostics.ProcessStartInfo
