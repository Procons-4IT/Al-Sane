...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OADM" Or strTab = "OWOR" Or strTab = "OASC" Or strTab = "INV1" Or strTab = "JDT1" Or strTab = "OINV" Or strTab = "ORDR") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddTables("Z_OALJDT", "Import Financial Details", SAPbobsCOM.BoUTBTableType.bott_NoObject)

            AddFields("Z_OALJDT", "Z_JDTNUM", "JOURNAL ENTRY NUMBER", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_OALJDT", "Z_LINENO", "LINE NUMBER", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_OALJDT", "Z_GLTYPE", "POSTING TYPE", SAPbobsCOM.BoFieldTypes.db_Alpha, , 5)
            AddFields("Z_OALJDT", "Z_ACCTCODE", "ACCOUNT CODE", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OALJDT", "Z_CURRENCY", "CURRENCY", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            AddFields("Z_OALJDT", "Z_DEBIT", "DEBIT AMOUNT", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_OALJDT", "Z_CREDIT", "CREDIT AMOUNT", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_OALJDT", "Z_DATE", "DOCDATE", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_OALJDT", "Z_LINEMEMO", "LINE MEMO", SAPbobsCOM.BoFieldTypes.db_Memo)
            AddFields("Z_OALJDT", "Z_PROJECT", "PROJECT ", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OALJDT", "Z_REF2", "REFERENCE 2", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            addField("@Z_OALJDT", "Z_Imported", "Imported", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            AddFields("Z_OALJDT", "Z_JDTREF", "JOURNAL REFERENCE", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)

            AddFields("JDT1", "Z_JDTNUM", "Journal Reference", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("JDT1", "Z_LineNo", "Journal Ref.Line", SAPbobsCOM.BoFieldTypes.db_Numeric)

            AddFields("Z_OALJDT", "Z_COST1", "oCrCode", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OALJDT", "Z_COST2", "oCrCode2", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OALJDT", "Z_COST3", "oCrCode3", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OALJDT", "Z_COST4", "oCrCode4", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OALJDT", "Z_COST5", "oCrCode5", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OALJDT", "Z_UDF1", "UDF1", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OALJDT", "Z_UDF2", "UDF2", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OALJDT", "Z_UDF3", "UDF3", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
